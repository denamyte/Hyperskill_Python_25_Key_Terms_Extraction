...
answer = {'Brain Disconnects During Sleep:': ["sleep", "cortex", "consciousness", "say", "tononi"],
          ...
          'Did you knowingly commit a crime? Brain scans could tell:': ["brain", "people", "say", "study", "suitcase"],
          'Computer learns to detect skin cancer more accurately than doctors:': ["dermatologist", "skin", "melanoma", "year", "cnn"],
          'US economic growth stronger than expected despite weak demand:': ["quarter", "year", "since", "rate", "growth"],
          'Microsoft becomes third listed US firm to be valued at $1tn:': ["microsoft", "share", "cloud", "market", "company"],
          "Apple's Siri is a better rapper than you:": ["siri", "like", "young", "time", "rhyme"],
